...
class _MyFormState extends State<MyForm> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
            backgroundColor: const Color.fromARGB(255, 191, 168, 243),
            title: const Text("Citlali Miscles"),
            centerTitle: true),
        body: Container(
          ...
          child: ListView(
            children: [
              MyTextField(
                  ...
                  prefixIconColor: const Color.fromARGB(255, 191, 168, 243)),
    ...
    return OutlinedButton(
      ...
      child: Text(
        ...
        style: const TextStyle(
            fontWeight: FontWeight.bold, color: Color.fromARGB(255, 134, 83, 255)),
      ),
    );
  }
}
